...
G=createGraph(r"C:\Python27\sjxwork\LNewCI\diandui1.csv")
LCI={}
Influence_set={}
LCIequalto0=[]
c=0
...
for nid in G.nodes():
    ...
    if LCI[nid]==0:
        ...
        Influence_set[nid]=CI[nid]
    else:
        pass
print LCIequalto0
sort_k=sorted(Influence_set.iteritems(), key=lambda d:d[1], reverse = True)
