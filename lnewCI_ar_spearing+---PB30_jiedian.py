...
def New_Collective_Influence(G):
    G_CI_value=Collective_Influence4(G)
...
# print S
# S = map(int, S)
#S=['723', '669', '391', '668', '344', '345', '346', '347', '340', '341', '342', '343', '810', '811', '812', '813', '348', '349', '816', '817', '664', '739', '719', '718', '717', '716', '715', '714', '713', '712']
S=[1032,	1093,	801	,710,	1152,	629	,1103	,345	,636	,643	,997	,837	,1078	,908	,999	,193	,886	,200	,360	,603	,1202,	862,	419	,1016,	809	,1064,	1099,	642	,641,	897]
S = map(int, S)
largest_cc_list=[]
remove_rate=[]
H_list=[]
