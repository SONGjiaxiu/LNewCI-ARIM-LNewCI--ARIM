...
def New_Collective_Influence(G):
    ...
    #list_G_CI_value
G=createGraph(r"C:\Users\Administrator\Desktop\dataset\216\soc.csv")
G1 = nx.Graph()
with open(r"C:\Users\Administrator\Desktop\dataset\216\soc.txt") as f:
